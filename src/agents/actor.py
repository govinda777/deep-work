    ...
    async def execute_task(self, task):
        ...
        if tool_type == "browser":
            if "navigate" in description.lower():
                ...
                return await self.browser_tools.double_click(params.get("selector"))
                ...
                return await self.browser_tools.hover(params.get("selector"))
            ...
            if "double click" in description.lower():
                return self.os_tools.double_click_at(params.get("x"), params.get("y"))
            elif "click" in description.lower():
            ...
            elif "drag" in description.lower():
